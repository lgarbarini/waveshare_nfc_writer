...
if __name__ == "__main__":
    ...
    ap.add_argument("title", type=str, help="URL to write to tag")
    ap.add_argument("description", type=str, help="URL to write to tag")
    args = ap.parse_args()
    ...
    futura = ImageFont.truetype("futura_medium.ttf", 20)
    futura_bold = ImageFont.truetype("futura_bold.ttf", 70)
